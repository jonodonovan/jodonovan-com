    ...
    <div class="row" style="padding:10px;">
        <div class="col-md-10 col-md-offset-1 text-center">
            ...
            <div style="position: relative; z-index: 2;">
                ...
                <a href="https://join.slack.com/t/lookingformarketing/shared_invite/zt-cfuzmdb7-HzQhKOu3rRttC~sRWqydxA" target="_blank"><buton class="btn btn-default btn-sm" style="margin:3px;"><i class="fa fa-commenting-o" aria-hidden="true"></i> Slack</buton></a>
                ...
                <a href="https://verticalorbit.com/?utm_source=link&utm_medium=footer&utm_campaign=jodonovan" target="_blank"><buton class="btn btn-default btn-sm" style="margin:3px;"><img src="/images/logo_v.png" name="verticalorbit" width="15px" border="0" class="hidden-xs"> Vertical Orbit</buton></a>
            </div>
        </div>
    </div>
</div>